...
def main(rank1):
    ...
    for epoch in range(FLAGS.epochs):
        ...
        # Validation
        cost, acc, _, duration = evaluate(ax_features, valSupport, y_val, placeholders)
    ...
    test_cost, test_acc, test_y_pred, test_duration = evaluate(ax_features, testSupport, y_test,
                                                               placeholders)
